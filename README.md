...
4. **Orchestration Layer / Existing OLLVM Passes**: Core control-flow flattening, bogus control flow, etc.
...
| 4 | `src/passes/existing/ollvm_passes.cpp` | Implements traditional OLLVM passes and orchestration. |
